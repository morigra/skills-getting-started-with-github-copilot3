...
activities = {
    ...
    "Soccer Team": {
        "description": "Team practices and matches for the school soccer team",
    ...
    "Drama Club": {
        "description": "Rehearse plays and perform dramatic scenes for school events",
        "schedule": "Thursdays, 4:00 PM - 6:00 PM",
        "max_participants": 20,
        "participants": ["lucas@mergington.edu", "chloe@mergington.edu"]
    },
    "Math Olympiad": {
        "description": "Practice challenging math problems and compete in contests",
